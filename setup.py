#!/usr/bin/env python
"""
Package metadata for goamazing_openedx_extensions_app.
"""
import os
import re
import sys
...
VERSION = get_version('goamazing_openedx_extensions_app', '__init__.py')
...
setup(
    ...
    author='GoAmazing',
    author_email='contact@goamazing.org',
    url='https://github.com/GoAmazing/goamazing_openedx_extensions_app',
    packages=find_packages(
        include=['goamazing_openedx_extensions_app', 'goamazing_openedx_extensions_app.*'],
        exclude=["*tests"],
    ),
