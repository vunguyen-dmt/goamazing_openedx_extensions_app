...
"""
goamazing_openedx_extensions_app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'goamazing_openedx_extensions_app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/GoAmazing/goamazing_openedx_extensions_app",
...
#
# html_title = 'goamazing_openedx_extensions_app v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'goamazing_openedx_extensions_app'),
                os.path.join(root_path, 'goamazing_openedx_extensions_app/migrations')])
